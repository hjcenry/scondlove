  ...
  <#list dealMessageList as dealMess>
	<div id="pur${dealMess.dealId}" onclick="getpurDetail('${dealMess.dealId}')">
		...
		<TR>
			...
			<TD><span class="bluefont">${dealMess.nickname}</span></TD>
...
<script type="text/javascript" >
	...
	function makeassign(){
		location.href="${request.contextPath}/assignment/makeassignment?flag=2";
	}
	
	function makepur(){
		location.href="${request.contextPath}/purchase/makepurchase?flag=2";
	}
