...
<div>
	<input type="hidden" id="dealType" name="dealType" value="2" />
 	<div  class="nav">
  		<img src="${request.contextPath}/images/back.gif" class="lnavimg" onclick="getpur()" />
	...
	<div data-role="fieldcontain">
		...
		<table style="width: 99%;">
			<tbody>
				...
				<#if Session.userVO.userId != dealMessage.createUser && dealMessage.dealType !=1>
				<tr>
					<td>
						<div class="tuoyuan">
...
<div class="wrapper_top" id="kuang" style="display:none;">
		<div class="warn">
			...
			<div class="warnneirong">
				<input type="text" id="offerDesc" name="offerDesc" placeholder="留言（必填）" />
			</div>
			<div class="warnneirong">
...
function indexReply(){
	...
	context = $('#context').val();
	if(context==''){
		$.DIC.dialog({content:'请填写回复内容!', autoClose:true});
		return false;
	}
	if(replyName!=''){
